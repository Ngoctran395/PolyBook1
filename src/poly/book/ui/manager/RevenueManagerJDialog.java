...
import poly.book.dao.RevenueController;
import poly.book.dao.RevenueDAO;
import poly.book.dao.impl.RevenueDAOImpl;
...
public class RevenueManagerJDialog extends javax.swing.JDialog implements RevenueController{
    ...
    private void initComponents() {
        ...
        Tabs.addTab("Doanh thu nhân viên", jPanel2);
        ...
        Tabs.addTab("Doanh thu theo sách", jPanel1);
        ...
        cboTimeRanges.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hôm nay", "Hôm qua", "Tuần này", "Tháng này", "Quý này", "Năm nay" }));
...
private void fillRevenueByCategory(Date begin, Date end) {
    ...
    items.forEach(item -> {
        Object[] row = {
            item.getCategory(),
            vndFormat.format(item.getRevenue()) + " VND",
            item.getQuantity(),
            vndFormat.format(item.getMinPrice()) + " VND",
            vndFormat.format(item.getMaxPrice()) + " VND",
            vndFormat.format(item.getAvgPrice()) + " VND"
        };
        model.addRow(row);
    });
}
